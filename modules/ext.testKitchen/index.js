...
function getExperiment( experimentName ) {
	...
	if (
		...
		console.log( 'mw.testKitchen.getExperiment(): The current user is not enrolled in ' +
		...
		if ( !userExperiments || !userExperiments.assigned[ experimentName ] ) {
			// eslint-disable-next-line no-console
			console.log( 'mw.testKitchen.getExperiment(): The "' + experimentName + '" experiment is not active ' +
