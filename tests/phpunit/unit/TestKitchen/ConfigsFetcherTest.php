...
namespace MediaWiki\Extension\TestKitchen\Tests\Unit\TestKitchen;
...
class ConfigsFetcherTest extends MediaWikiUnitTestCase {
	...
	public static function provideRequestFailures(): Generator {
		...
		yield [
			...
			'',
			[
				new MessageValue( 'testkitchen-non-successful-response' ),
				new MessageValue( 'testkitchen-api-empty-response-body' ),
			],
		];
	}
