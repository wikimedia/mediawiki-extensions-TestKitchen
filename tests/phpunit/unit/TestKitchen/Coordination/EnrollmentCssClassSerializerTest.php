...
/**
 * @covers \MediaWiki\Extension\TestKitchen\Coordination\EnrollmentCssClassSerializer
 */
class EnrollmentCssClassSerializerTest extends MediaWikiUnitTestCase {
	public function testSerialize(): void {
		...
		$expected = [
			'test-kitchen-experiment-fruit',
			'test-kitchen-experiment-fruit-tropical',
			'test-kitchen-experiment-dinner',
			'test-kitchen-experiment-dinner-get-takeout',
			'test-kitchen-experiment-not-a-slug',
			'test-kitchen-experiment-not-a-slug-foo',
			'test-kitchen-experiment-_experiment-platform',
			'test-kitchen-experiment-_experiment-platform-bar',
		];
