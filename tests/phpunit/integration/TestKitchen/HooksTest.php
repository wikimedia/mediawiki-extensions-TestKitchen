...
namespace MediaWiki\Extension\TestKitchen\Tests\Integration;
	...
	extends MediaWikiIntegrationTestCase
{
	...
	private function onBeforeInitialize(): array {
		...
		return $this->output->getJsConfigVars()['wgTestKitchenUserExperiments'];
	}
	...
	/**
	 * Tests whether the ext.testKitchen module is added to the output even when the user is not enrolled in any active
	 * experiments.
	 */
